...
--
-- Name: periodic_type_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.periodic_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public.periodic_type_id_seq OWNER TO freecodecamp;
...
CREATE TABLE public.types (
    type_id integer DEFAULT nextval('public.periodic_type_id_seq'::regclass) NOT NULL,
...
--
-- Name: periodic_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.periodic_type_id_seq', 3, true);
